...
const ComparisonTable = () => {
  const features = [
    { name: "Real-time Price Tracking", vantage: true, others: true },
    { name: "Historical Price Graphs", vantage: true, others: false },
    { name: "AI Price Prediction", vantage: true, others: false },
    { name: "Multi-store Comparison", vantage: "50+ Stores", others: "5-10 Stores" },
    { name: "Browser Extension", vantage: true, others: true },
    { name: "Verified Coupons", vantage: true, others: false },
    { name: "Ad-free Experience", vantage: true, others: false },
  ];
    ...
    <section className="py-32 px-6 max-w-5xl mx-auto">
      <div className="text-center mb-20">
        <h2 className="text-5xl font-bold tracking-tighter mb-6">
          The <span className="text-gradient">Vantage</span> Edge
        </h2>
            ...
            <tr className="border-b border-gray-100">
              ...
              <th className="p-8 text-center bg-purple-50/50">
                <div className="flex flex-col items-center gap-2">
                  ...
                  <span className="font-bold text-gray-900">Vantage</span>
                </div>
              </th>
            ...
            {features.map((f, i) => (
              ...
              >
                ...
                <td className="p-8 text-center bg-purple-50/30">
                  {typeof f.vantage === 'boolean' ? (
                    f.vantage ? <Check className="w-6 h-6 text-purple-600 mx-auto" /> : <X className="w-6 h-6 text-gray-300 mx-auto" />
                  ) : (
                    <span className="font-bold text-purple-700">{f.vantage}</span>
                  )}
                </td>
